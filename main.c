...
void menuMochila(mochila mochilita[3])
{
    ...
    while(control == 's')
    {
        ...
        case 4:
            ...
            fflush(stdin);
            scanf("%d", &indice);
            MostarUnaCategoria(mochilita,indice-1);
            break;
        case 5:
